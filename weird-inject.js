(function() {
  if (window.top === window.self) {
    ...
    const saReport = function () {
      ...
      xhr.open('POST', document.location.origin + '/5e0e828fb6c81fc778b35dfa2819aa5596fc52a2aed5fcd2075d185235c26152/log', true);
    ...
    if (window.location.href.match(/(^|\.)youtube\./)) {
      ...
      const applyYouTube = function () {
        ...
        xhr.open('POST', document.location.origin + '/5e0e828fb6c81fc778b35dfa2819aa5596fc52a2aed5fcd2075d185235c26152/ytconf', true);
        xhr.send(JSON.stringify(body));
      ...
      const blockYTImg = '/5e0e828fb6c81fc778b35dfa2819aa5596fc52a2aed5fcd2075d185235c26152/blocked-yt-image.png';
...
class Flags {
  ...
  Report(flags) {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('POST', document.location.origin + '/5e0e828fb6c81fc778b35dfa2819aa5596fc52a2aed5fcd2075d185235c26152/log_flag', true);
